...
export default function Home() {
  ...
  const tutorialChapters: TutorialChapter[] = [
    {
      id: 0,
      title: "១. ការរៀនពីរបៀបដើររបស់កូនអុកទាំងអស់ (Movements Sandbox)",
      description: "ស្វែងយល់ និងសាកល្បងរបៀបដើរកូនអុកទាំងអស់នៅលើក្តារ។ អ្នកអាចចុចលើកូនអុកណាមួយ ដើម្បីសាកល្បងដើរវាដោយសេរី រួមទាំងការលោតពិសេសរបស់ស្តេច និងនាង។",
      instructions: (history: Move[]) => {
        ...
        return "អបអរសាទរ! បងបានសាកល្បងគ្រប់គ្រាន់ហើយ! ចុច 'មេរៀនបន្ទាប់' ដើម្បីទៅមេរៀនបន្ទាប់! 🏆";
      },
      setup: () => {
